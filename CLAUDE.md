...
- **Known issue:** Option+Click in the editor adds a multi-cursor instead of performing NSTextView's default rectangular/column selection. This matches Xcode/VS Code behavior and is intentional.
