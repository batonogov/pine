...
- **Git hooks:** `git config core.hooksPath .githooks` — enables pre-commit hook that auto-unstages cosmetic-only changes to `Localizable.xcstrings` (Xcode build artifacts). Run once after cloning
